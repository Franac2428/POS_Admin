        ...
        <button onClick={onClose} className="absolute top-2 right-2 p-1 rounded-lg text-gray-400 hover:bg-gray-50 hover:text-gray-600 dark:hover:bg-gray-700 dark:hover:text-gray-300">
          <X size={18} strokeWidth={2} />
            ...
            <div className="lg:w-full w-full ml-2 mr-2">
                <label htmlFor="montoVuelto" className="block mb-2 text-md font-medium text-gray-900 dark:text-white">Correo del usuario:</label>
            ...
            <div className="flex justify-end gap-4 ">
              <button className="bg-green-600 font-semibold rounded-md py-2 px-6 text-white" onClick={handleCambioClave}>Enviar
              </button>
              <button
