...
export default function DeleteHorario({ open, onClose, horarioId, mutate }) {
        ...
        <div className="fixed inset-0 overflow-y-auto overflow-x-hidden flex justify-center items-center z-50 bg-black bg-opacity-20">
            <div className="relative bg-white rounded-lg shadow-xl transition-all transform scale-100 opacity-100 w-full max-w-md">
                ...
                <div className="p-6 text-center">
                    ...
                    <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">¿Seguro que desea eliminar este horario?</h3>
                    {horario && (
                        <div className="text-gray-800 text-md">
                            <p><span className="font-bold">ID:</span> {horarioId}</p>
                            <p><span className="font-bold">Día:</span> {horario.Dia}</p>
                            <p><span className="font-bold">Horario:</span> {horario.HoraInicio} - {horario.HoraFin} </p>
